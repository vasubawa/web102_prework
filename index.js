...
const companyInfoString = `Our company has raised 
$${totalRaised.toLocaleString()} to fund 
${GAMES_JSON.length.toLocaleString()} games. Currently, 
there ${numUnfundedGames === 1 ? 'is' : 'are'} 
${numUnfundedGames.toLocaleString()} 
unfunded ${numUnfundedGames === 1 ? 'game' : 'games'}
that still ${numUnfundedGames === 1 ? 'needs' : 'need'} your help!`;

// create a new DOM element containing the template string and append it to the description container
const infoElement = document.createElement('p');
infoElement.innerHTML = companyInfoString;
